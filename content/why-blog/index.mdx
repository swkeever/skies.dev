---
date: 2020-07-31
title: Why I Built Skies and Started Blogging
description: What are the benefits of building your own site and blogging?
tags:
...
what I know or things I've done. A blog gives me a platform to write about
things I've done in a longer, more complete format.
...
content I publish and the site's user experience. This leads directly into my
next point.
...
I also _enjoy_ web design and front-end web development. The Skies site can be a
playground to try out design ideas. If I want to support dark mode, then I can
support dark mode. If I want a 3-column card layout, then I can implement the
damn 3-column layout. 😂

I like being able to know I can expand the site to my
heart's content.
...
<aside>
  <p>
    ☝️ I have another blog post where I explain the&nbsp;
    <ExternalLink href="/blog/tech-stack">tech stack</ExternalLink>&nbsp;I used for
    the Skies website.
  </p>
</aside>

I recommend this tool if you are a developer and you want to have full control
over the site.
...
same goal. For instance, there's [Gridsome](https://gridsome.org/) for Vue.js.
...
Medium is a solid platform for blogging though if you just want to get
up-and-running quickly. Of course, you don't have as much flexibility to control
the user experience of the site, but that may or may not be an issue for you.
