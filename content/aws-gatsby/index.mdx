...
description:
  Learn how to set up a static Gatsby website on AWS declaring infrastructure as
  code.
category: 1
keywords:
  - aws
...
tags:
  ...
  - AWS
  - Backend
imagePhotographer: Scott Webb
imageUrl: https://unsplash.com/photos/-udZnjsCzsE
image: index.jpg
---
...
follow the **principle of least privilege** and give Terraform and GitHub
Actions only the permissions it needs to do its job—and nothing more.
...
your project. The implementation is very similar to the one mentioned in the
video.
...
exports.handler = (event, context, callback) => {
  ...
  if (!host.startsWith('www.')) {
    let newUrl = 'https://www.yourdomain.com';
