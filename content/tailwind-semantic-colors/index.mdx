---
date: 2020-09-04
title: Setting Up Different Color Themes with Tailwind CSS and React
description:
...
- A _riddle_ to help you find the **super secret color switcher** on Skies.
...
An analalogous table applies for the neutrals as well.
...
I'm going to leave you with a hint to help you find the _super secret theme
switcher_ on Skies.

The hint is:

> _A hero points to the last airbender._

Good luck finding this little easter egg! 😄

**What are your favorite tricks for theming with CSS?** Let me know on
