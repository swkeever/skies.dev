...
date:
  ...
  modified: 2020-06-20
title: PurgeCSS with Gatsby and Tailwind CSS
description: How to tell PurgeCSS to not remove styles that are sourced from markdown files.
categoryId: 1
authorId: 0
keywords:
  - how to purge tailwind css gatsby
tags:
  - Gatsby
  - Tailwind CSS
image:
  src:
    local: index.jpg
    external: https://unsplash.com/photos/BlIhVfXbi9s
