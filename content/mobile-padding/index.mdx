...
description: This article explains a simple tip that you can apply to
  dynamically add extra padding for mobile devices.
categoryId: 1
authorId: 0
keywords:
  - css
...
image:
  src:
    local: index.jpg
    external: https://unsplash.com/photos/ND0-l3gZ_Y4
  photographer: Andisheh A
---
