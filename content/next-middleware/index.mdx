...
Next.js does not have this kind of first-class support built in. However, there is [next-connect](https://www.npmjs.com/package/next-connect)
...
If this looks confusing to you—functions passing in functions passing in functions—
