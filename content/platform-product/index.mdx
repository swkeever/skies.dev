...
description: Learn how companies benefited from offering their platforms as a
  service, either through infrastructure or external APIs.
categoryId: 0
authorId: 0
keywords:
...
image:
  src:
    local: index.jpg
    external: https://unsplash.com/photos/T5nXYXCf50I
