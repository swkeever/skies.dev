...
image:
  src:
    local: index.jpg
    external: https://unsplash.com/photos/lt6gE86VyaA
  photographer: Bill Jelen
---

## How to Build and Deploy a Gatsby Site to AWS with GitHub Actions

In the [previous tutorial](/aws-gatsby), we set up all the infrastructure
