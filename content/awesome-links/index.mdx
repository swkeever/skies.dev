---
migrated: /sharable-cards
date:
  published: 2020-06-25
  modified: 2020-09-24
title: Improve SEO with Social Sharing Cards
description: Check out this simple tip that you can apply to make links back to
  your website on social media look awesome.
categoryId: 1
authorId: 0
keywords:
  - twitter card meta
...
image:
  src:
    local: index.jpg
    external: https://unsplash.com/photos/vj_9l20fzj0
  photographer: Modestas Urbonas
---
...
![Identifying the title and description on a search engine results page.](results.jpg)
...
<aside>
  ...
  <p>&lt;meta name="name" content="content" /&gt;</p>
</aside>
...
<aside>
  <p>
    Open-Graph meta tags are of the following form. Notice, we use{' '}
    <strong>property</strong> instead of <strong>name</strong> here.
  </p>
  <p>&lt;meta property="og:name" content="content" /&gt;</p>
</aside>
...
<aside>
  <p>Twitter meta tags are of the following form:</p>
  <p>&lt;meta name="twitter:name" content="content" /&gt;</p>
</aside>
...
When specifying the URL for your image metadata, make sure to **use an absolute
URL, not a relative URL**. Twitter will not be able to resolve a relative URL,
and your image will not be displayed on the card.

<Danger>
<h4>Incorrect</h4>

<p>&lt;meta name="twitter:image" content="/image.jpg"/&gt;</p>
</Danger>
