...
<p>
  When specifying the URL for your image metadata, make sure to{' '}
  <strong>use an absolute URL, not a relative URL</strong>. Twitter will not be
  able to resolve a relative URL, and your image will not be displayed on the
  card.
</p>
...
<p>&lt;meta name="twitter:image" content="https://skies.dev/image.jpg"/&gt;</p>
