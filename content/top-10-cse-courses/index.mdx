---
migrated: /college/courses
date:
  published: 2020-06-22
  modified: 2020-06-22
title: Best Computer Science Courses
description: Check out the top 10 computer science courses and pointers to
  resources to help learn each course on your own.
categoryId: 0
authorId: 0
keywords:
  - best computer science courses
  - top computer science courses
  - most useful computer science courses
tags:
  - Computer Science
  - College
image:
  src:
    local: index.jpg
    external: https://unsplash.com/photos/GkFQEOubrCo
...
- basic structures like lists, [stacks](/stacks), and queues
...
<aside>
  <p>
    ...
    <ExternalLink href="https://www.youtube.com/watch?v=XKu_SEDAykw">
      example
    </ExternalLink> provided by Google.
  </p>
</aside>
