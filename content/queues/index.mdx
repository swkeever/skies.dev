...
description: Learn about the queue data structure.
category: 1
keywords:
...
tags:
  ...
  - Computer Science
image: index.jpg
imagePhotographer: Florencia Viadana
imageUrl: https://unsplash.com/photos/mixpzw_FlcA
---
...
<aside>
  <p>
    In the U.S., we often refer to a queue as a <em>line</em>.
  </p>
</aside>
...
<aside>
  <p>
    <strong>Pseudocode</strong> refers to high-level code that is not associated
    with any programming language. It's used to give an understanding of how the
    code works without being detailed about specific syntax.
  </p>
</aside>
