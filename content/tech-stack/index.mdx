...
drive this site. I chose Gatsby for serveral reasons.
...
- [gatsby-plugin-mdx](https://www.gatsbyjs.org/packages/gatsby-plugin-mdx/):
  ...
  is a convienent way of quickly writing content using markdown but still having
...
There are other many other plugins that I use for other things here and there.
Check out my
...
less strict giving me the option to opt of writing out all the types when I'm
being lazy or am in a hurry. This is not too much of problem though because the
tooling I've set up reminds me to fix any development shortcuts I may have made.
...
ahere to a design system, but I didn't want to be locked into a component-based
...
can hook into a class name and a CSS rule with a sensible value will
...
itHub. With _very little_ setup, I set up CD to trigger a new build of the site
whenever I push a new commit to the `master` branch. This makes it really easy
to hot-fix bugs and push new features. Netlify also makes it easy to enable a
SSL/TLS certicate so visitors on my site feel secure. Super cool stuff.
