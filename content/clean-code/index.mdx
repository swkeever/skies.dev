---
migrated: /swe/clean-code
date:
  published: 2020-06-26
  modified: 2020-06-26
title: Clean Code
description: Come check out common patterns to keep in mind when writing clean code.
categoryId: 0
authorId: 0
keywords:
  - what is clean code
...
image:
  src:
    local: index.jpg
    external: https://unsplash.com/photos/m2J105CzEAU
...
<aside>
  <p>
    A <strong>style guide</strong> is a set of rules that specify how code
    should be formatted.
  </p>
</aside>
...
<aside>
  <p>
    A <strong>linter</strong> is software that modifies code to enforce the
    rules of a style guide.
  </p>
</aside>
...
<aside>
  <p>
    Try looking at code from one of your old projects. Do you remember how the
    code works? Is the code easy to understand? If so, great! Perhaps you have
    written <em>clean code</em>.&nbsp;
