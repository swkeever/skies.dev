...
description: Come check out why I believe Python is the best programming
  language to learn as a total beginner.
categoryId: 0
authorId: 0
keywords:
...
image:
  src:
    local: index.jpg
    external: https://unsplash.com/photos/yrcaXCWe0VY
