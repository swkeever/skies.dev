...
description:
  Learn the basics of writing unit tests and practicing test-driven development
...
https://twitter.com/davecheney/status/1178289934542655489?s=20

Suppose for example we are working at the hottest banking SaaS startup.
